...
function calculateAge(birthYear, countYear) {
  const yearOrYears = Math.abs(birthYear - countYear) === 1 ? "year" : "years";

  return birthYear < countYear
    ? `You are ${countYear - birthYear} ${yearOrYears} old.`
    : birthYear > countYear
    ? `You will be born in ${birthYear - countYear} ${yearOrYears}.`
