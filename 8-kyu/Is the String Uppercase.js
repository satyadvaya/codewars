...
describe("Fixed Tests", () => {
  ...
  it("should also work for a few other basic tests", () => {
    ...
    assert.strictEqual(
      "HELLO WORLD".isUpperCase(),
      true,
      "HELLO WORLD is upper case"
    );
    assert.strictEqual(
      "Bob walks his dog every day.".isUpperCase(),
      false,
      "Bob walks his dog every day. is not upper case"
    );
    assert.strictEqual(
      "BOB walks his dog every day.".isUpperCase(),
      false,
    ...
    assert.strictEqual(
      "BOB WALKS HIS DOG EVERY DAY.".isUpperCase(),
      true,
      "BOB WALKS HIS DOG EVERY DAY. is upper case"
    );
    assert.strictEqual(
      "BOB WALKs HIS DOG EVERY DAY.".isUpperCase(),
      false,
