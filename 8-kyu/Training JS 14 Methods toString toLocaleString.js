...
function colorOf(r, g, b) {
  return (
    "#" +
    [...arguments].map((color) => `0${color.toString(16)}`.slice(-2)).join("")
  );
}

// function colorOf(r, g, b) {
//   return '#' + [r, g, b].map(color => `0${color.toString(16)}`.slice(-2)).join('');
// }

// function colorOf(r, g, b) {
//   return '#' + [...new Array(r, g, b)].map(color => `0${color.toString(16)}`.slice(-2)).join('');
// }
